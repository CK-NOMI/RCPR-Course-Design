...
​
> 西南交通大学《视觉计算》课程设计
> 设计题目：**基于鲁棒共识原型细化的自监督共显著目标检测设计与实现**
​
...
## 二、方法概述（RCPR）
​
RCPR 在 SCoSPARC 自监督基线之上做推理阶段适配改进，借鉴 CoRP「共同表示需要净化」的思想，但针对自监督伪掩码不可靠的特点重新设计了以下模块：
​
| 模块 | 名称 | 作用 |
| --- | --- | --- |
...
## 十、主要参考工作
​
- SCoSPARC（复现基线）：Self-supervised CoSOD via feature correspondences at multiple scales, ECCV 2024.
- CoRP（净化思想来源）：Co-salient object detection with co-representation purification, TPAMI 2023.
